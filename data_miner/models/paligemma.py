...
class PaliGemmaHelper:
    ...
    def detect(
        ...
        # Build detection prompt: "detect obj1 ; obj2 ; obj3"
        ...
        output_text = self.processor.decode(generation[0][input_len:], skip_special_tokens=False)
        
        self.latencies.append(time.perf_counter() - t0)
        
        # Parse detections from output
        raw_detections = self._parse_detections(output_text, (image_width, image_height))
    ...
    def describe(
        ...
        return self.processor.decode(generation[0][input_len:], skip_special_tokens=True)
    ...
    def answer(
        ...
        prompt = f"answer {language} {question}"
...
if __name__ == "__main__":
    ...
    pali = PaliGemmaHelper(
        detection_class=["door", "glass door", "entrance"],
