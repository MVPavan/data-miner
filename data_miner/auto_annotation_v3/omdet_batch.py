...
``dart_batch.Sam3MultiClassPredictorBatch`` for DART/SAM3.
...
class OmDetTurboBatchPredictor:
    ...
    def __init__(
        ...
        # 224×224 instead of the config's 640×640.  Recreate the timm model
    ...
    def _fix_backbone_img_size(self) -> None:
        ...
        PatchEmbed defaults to 224×224.  This method recreates the timm
    ...
    def set_images(
        ...
        (default 640×640).  The backbone and encoder run ONCE for the entire
