...
### CLI ([cli.py](../video_miner_async/cli.py))
...
|---------|----------|-------------|
| `run-config` | [run_config()](../video_miner_async/cli.py#L390-L469) | Run pipeline from YAML config file(s) |
| `validate-config` | [validate_config_cmd()](../video_miner_async/cli.py#L472-L504) | Validate YAML config without running |
| `registry status` | [registry_status()](../video_miner_async/cli.py#L113-L142) | Show registry statistics |
| `registry list` | [registry_list()](../video_miner_async/cli.py#L178-L221) | List videos in registry |
| `registry export` | [registry_export()](../video_miner_async/cli.py#L145-L175) | Export URLs to file |
...
The [_execute_pipeline()](../video_miner_async/cli.py#L228-L387) function:
...
### Pydantic Models ([config.py](../video_miner_async/config.py))
...
|------|--------|----------|
| `DetectorType` | dino-x, moondream3, florence2, grounding-dino | [config.py:35-40](../video_miner_async/config.py#L35-L40) |
| `SamplingStrategy` | interval, time, keyframe | [config.py:43-47](../video_miner_async/config.py#L43-L47) |
| `FilterModel` | siglip2-so400m, siglip2-giant | [config.py:50-53](../video_miner_async/config.py#L50-L53) |

### OmegaConf Loader ([config_loader.py](../video_miner_async/config_loader.py))
...
Key functions:
- [load_config()](../video_miner_async/config_loader.py#L21-L86) - Load and merge YAML configs
- [validate_config()](../video_miner_async/config_loader.py#L115-L212) - Validate required fields
- [print_config()](../video_miner_async/config_loader.py#L215-L226) - Pretty print configuration

### Constants ([constants.py](../video_miner_async/constants.py))
...
### VideoPipeline ([pipeline.py](../video_miner_async/pipeline.py))
...
[VideoPipeline.run()](../video_miner_async/pipeline.py#L186-L307):
...
The pipeline uses [_filter_by_registry()](../video_miner_async/pipeline.py#L138-L184) to skip already-processed videos:
...
### 1. Downloader ([downloader.py](../video_miner_async/modules/downloader.py))
...
**Key Methods:**
- [download_single()](../video_miner_async/modules/downloader.py#L110-L203) - Download one video
- [download_batch()](../video_miner_async/modules/downloader.py#L205-L317) - Concurrent batch download
- [gather_input_urls()](../video_miner_async/modules/downloader.py#L320-L370) - Collect URLs from config sources

---

### 2. Frame Extractor ([frame_extractor.py](../video_miner_async/modules/frame_extractor.py))
...
**Key Methods:**
- [iterate_frames()](../video_miner_async/modules/frame_extractor.py#L155-L232) - Generator yielding FrameInfo
- [extract_video()](../video_miner_async/modules/frame_extractor.py#L234-L337) - Extract and save frames
- [extract_batch()](../video_miner_async/modules/frame_extractor.py#L339-L438) - Concurrent batch extraction

---

### 3. Frame Filter ([frame_filter.py](../video_miner_async/modules/frame_filter.py))
...
**Key Methods:**
- [filter_frames()](../video_miner_async/modules/frame_filter.py#L75-L193) - Filter single video frames
- [filter_batch()](../video_miner_async/modules/frame_filter.py#L195-L242) - Filter multiple videos

---

### 4. Deduplicator ([deduplicator.py](../video_miner_async/modules/deduplicator.py))
...
**Key Methods:**
- [deduplicate()](../video_miner_async/modules/deduplicator.py#L247-L333) - Single batch deduplication
- [deduplicate_cross_video()](../video_miner_async/modules/deduplicator.py#L335-L465) - Two-phase cross-video dedup
- [_faiss_dedup()](../video_miner_async/modules/deduplicator.py#L190-L245) - FAISS-based O(N log N) dedup

---

### 5. Object Detector ([detector.py](../video_miner_async/modules/detector.py))
...
**Key Methods:**
- [detect_single()](../video_miner_async/modules/detector.py#L78-L107) - Detect in one image
- [detect_batch()](../video_miner_async/modules/detector.py#L169-L248) - Batch detection with progress
...
### Base Model ([base.py](../video_miner_async/models/base.py))
...
**Utilities:**
- [load_image()](../video_miner_async/models/base.py#L26-L54) - Convert Path/np.array/PIL to RGB Image
- [create_batch_iterator()](../video_miner_async/models/base.py#L139-L165) - Batch iterator with tqdm
- [load_model_with_fallback()](../video_miner_async/models/base.py#L172-L201) - Try multiple model IDs

---

### SigLIP Model ([siglip_model.py](../video_miner_async/models/siglip_model.py))
...
### DINOv3 Model ([dinov3_model.py](../video_miner_async/models/dinov3_model.py))
...
### Detector Models ([detector_models.py](../video_miner_async/models/detector_models.py))
...
### VideoRegistry ([registry.py](../video_miner_async/registry.py))
...
**Key Methods:**
- [add_video()](../video_miner_async/registry.py#L181-L212) - Add video to registry
- [update_stage()](../video_miner_async/registry.py) - Update stage completion
- [get_pending()](../video_miner_async/registry.py) - Get unprocessed videos
- [save()](../video_miner_async/registry.py) - Thread-safe YAML save

---

## Utility Functions

### Device Management ([device.py](../video_miner_async/utils/device.py))
...
### I/O Utilities ([io.py](../video_miner_async/utils/io.py))
